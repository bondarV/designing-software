...
{
    $image = new Image(element: ElementFactory::getFlyweight('img'), strategy: new NetworkImageStrategy(), source: "https://cdn.pixabay.com/photo/2016/11/16/05/11/man-1828202_1280.jpg");
